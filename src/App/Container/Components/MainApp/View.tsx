          ...
          <tr>
            <td className="flex flex-row whitespace-no-wrap justify-between text-left pl-6 text-gray-600 text-sm font-bold">
              ...
              <div className="text-xs my-1 mr-6 flex flex-row items-center">
                ...
                <button className="bg-bluepindad-300 hover:bg-blue-900 text-white px-4 py-1 inline-flex items-center border border-gray-700">
                  Selesai
                </button>
                <button className="bg-greenpindad-100 hover:bg-green-700 text-white px-4 py-1 inline-flex items-center border border-gray-600">
                  <svg
